    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h4 class="mb-0"><i class="bi bi-book"></i> Create New Book</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('books.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        @if($authors->count() == 0)
                            <small class="text-warning">No authors available. <a href="{{ route('authors.create') }}">Create one first</a></small>
                        @endif
                    </div>
